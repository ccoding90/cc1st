  ...
  return (
    <div className="app-main">
      <nav className="navbar">
        <div className="nav-brand">Intranet Board</div>
      </nav>
      <main className="main-content">
        {view === 'list' && (
          <PostList onSelectPost={handleSelectPost} onNewPost={() => setView('form')} />
        )}
        {view === 'form' && (
          <PostForm onCancel={() => setView('list')} />
        )}
        {view === 'detail' && (
          <PostDetail postId={selectedPostId} onBack={() => setView('list')} />
        )}
      </main>
    </div>
  );
